...
import { goldTrophies, silverTrophies, otherAchievements } from '../../data/achievements';
...
const pillarIcons = [
  // Self-Belief — Flame
  <svg key="flame" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  <svg key="unity" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  <svg key="compass" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="container">
        ...
        >
          ...
          <h2 className={styles.journeyTitle}>
            The <span className={styles.journeyTitleGold}>Journey</span>
          </h2>
        </motion.div>
              ...
              >
                <div className={styles.imageFrame}>
                  ...
                  <span className={styles.imageStep}>
                    {String(activeIdx + 1).padStart(2, '0')}/{String(miniTimelineData.length).padStart(2, '0')}
                  </span>
                </div>
    ...
    <section className={`section ${styles.philSection}`} ref={ref}>
      ...
      <div className="container">
        ...
        >
          ...
          <h2 className="section-title">Coaching <span className="gold-text">Pillars</span></h2>
        </motion.div>
        ...
        <div className={styles.pillarGrid}>
          {pillars.map((p, i) => (
            ...
            >
              <span className={styles.pillarIdx}>{String(i + 1).padStart(2, '0')}</span>
    ...
    <section className={`section ${styles.achieveSection}`} ref={ref}>
      <div className="container">
        ...
        >
          ...
          <h2 className="section-title">Trophy <span className="gold-text">Cabinet</span></h2>
        </motion.div>
        ...
        <div className={styles.trophySection}>
          ...
          <div className={styles.trophyGrid}>
            {goldTrophies.map((t, i) => (
              <motion.div key={i} className={`${styles.trophyCard} ${styles.goldCard}`}
                initial={{ opacity: 0, y: 15 }} animate={isVisible ? { opacity: 1, y: 0 } : {}}
        ...
        <div className={styles.trophySection}>
          ...
          <div className={styles.trophyGrid}>
            {silverTrophies.map((t, i) => (
              <motion.div key={i} className={`${styles.trophyCard} ${styles.silverCard}`}
                initial={{ opacity: 0, y: 15 }} animate={isVisible ? { opacity: 1, y: 0 } : {}}
                transition={{ duration: 0.4, delay: 0.1 + i * 0.08 }}
                whileHover={{ y: -3, transition: { duration: 0.2 } }}>
        ...
        <div className={styles.trophySection}>
          ...
          <div className={styles.trophyGrid}>
            {otherAchievements.map((t, i) => (
              <motion.div key={i} className={styles.trophyCard}
                initial={{ opacity: 0, y: 15 }} animate={isVisible ? { opacity: 1, y: 0 } : {}}
                transition={{ duration: 0.4, delay: 0.1 + i * 0.08 }}
                whileHover={{ y: -3, transition: { duration: 0.2 } }}>
    ...
    <section className={`section ${styles.teamsSection}`} ref={ref}>
      <div className="container">
        ...
        >
          ...
          <h2 className="section-title">Teams <span className="gold-text">Coached</span></h2>
        </motion.div>
        <div className={styles.teamGrid}>
          {teamsData.map((cat, i) => (
            <motion.div key={cat.category} className={styles.teamCategory}
              initial={{ opacity: 0, y: 15 }} animate={isVisible ? { opacity: 1, y: 0 } : {}}
              transition={{ duration: 0.5, delay: 0.1 + i * 0.1 }}>
              <div className={styles.catHeader}>
                <span className={styles.catIdx}>{String(i + 1).padStart(2, '0')}</span>
              ...
              <div className={styles.teamBadges}>
                {cat.teams.map((team, j) => (
                  <motion.span
                    ...
                    transition={{ duration: 0.3, delay: 0.25 + i * 0.08 + j * 0.04 }}
                  >
                    {team}
                  </motion.span>
                ))}
    ...
    <section className={`section ${styles.recogSection}`} ref={ref}>
      <div className="container">
        ...
        >
          ...
          <h2 className="section-title">In Their <span className="gold-text">Words</span></h2>
        </motion.div>
        <div className={styles.quoteGrid}>
          {recognitionQuotes.map((q, i) => (
            <motion.div key={i} className={styles.quoteCard}
    ...
    <section className={`section ${styles.testSection}`} ref={ref}>
      <div className="container">
        ...
        >
          ...
          <h2 className="section-title">What People <span className="gold-text">Say</span></h2>
        </motion.div>
        <div className={styles.testGrid}>
          {testimonials.map((t, i) => (
            <motion.div
              key={i}
              className={`${styles.testCard} ${i === activeIndex ? styles.testActive : ''}`}
